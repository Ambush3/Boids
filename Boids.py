...
class Boids:
    ...
    def __init__(self, N):
        ...
        self.N = N
        # minimum dist of approach
        self.minDist = 25.0
        # maximum magnitude of velocities calc by "rules"
        self.maxRuleVel = 0.03
        # max magnitude of the final velocity
        self.maxVel = 2.0
    ...
    def applyRules(self):
        ...
        # distance threshold for alignment (diff from separation)
    ...
    def buttonPress(self, event):
        """Event handler for matplotlib presses"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Implimenting Craig Reynolds Boids...")
